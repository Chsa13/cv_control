...
while (True):
    ...
    if len(m) == 2:
        ...
        if t1==t2: u = 90
        elif t1>t2: u = math.atan((l2-l1)/(t1-t2))*180/3.14
        else: u = 180-math.atan((l2-l1)/(t2-t1))*180/3.14
        ...
        cv2.putText(frame, str(round(u))+"deg", (l1+40, t1-40), cv2.FONT_HERSHEY_SIMPLEX,1, (255, 0, 0), 2, cv2.LINE_AA)
